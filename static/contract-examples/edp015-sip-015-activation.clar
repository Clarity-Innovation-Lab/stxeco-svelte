;; DAO: Ecosystem DAO
;; The vote requires 66% majority in favour to pass.
;; Title: Vote to Implement Stacks 2.1 Upgrade
;; Author(s): Aaron Blankstein, Mike Cohen, Greg Coppola, Brice Dobry, 
;; Hero Gamer, Matthew Little, Jenny Mith, Jude Nelson, 
;; Pavitthra Pandurangan, Rena Shah, Hank Stoever, Igor Sylvester, 
;; Jesse Wiley
