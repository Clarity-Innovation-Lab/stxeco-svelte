<script lang="ts">
	...
	let st1 = '<p>Getting the community involved via the DAO<ol><li>Activate SIP becomes a DAO Proposal</li><li>Rules of the DAO apply - e.g.</li><li>Voting starts in 1 day / ends in 1 week</li></ol></p>'
